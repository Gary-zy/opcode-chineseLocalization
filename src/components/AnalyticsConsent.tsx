        ...
        <div className="p-6 pb-0">
          <DialogHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <DialogTitle className="text-2xl">帮助改进 opcode</DialogTitle>
            </div>
            <DialogDescription className="text-base mt-2">
              我们希望收集匿名的使用数据，以改善您的使用体验。
            </DialogDescription>
          </DialogHeader>
        </div>
          ...
          <div className="space-y-3">
            <Card className="p-4 border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-950/20">
              <div className="flex gap-3">
                ...
                <div className="space-y-1">
                  <p className="font-medium text-green-900 dark:text-green-100">我们收集的内容：</p>
                  <ul className="text-sm text-green-800 dark:text-green-200 space-y-1">
                    <li>• 功能使用情况（您使用了哪些工具和命令）</li>
                    <li>• 性能指标（应用的运行速度和可靠性）</li>
                    <li>• 错误报告（用于修复漏洞和提高稳定性）</li>
                    <li>• 通用使用模式（会话频率和持续时间）</li>
                  </ul>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4 border-blue-200 dark:border-blue-900 bg-blue-50 dark:bg-blue-950/20">
              <div className="flex gap-3">
                ...
                <div className="space-y-1">
                  <p className="font-medium text-blue-900 dark:text-blue-100">您的隐私将受到保护：</p>
                  <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                    <li>• 不收集个人信息</li>
                    <li>• 不收集文件内容、路径或项目名称</li>
                    <li>• 不收集 API 密钥或敏感数据</li>
                    <li>• 完全匿名，使用随机 ID</li>
                    <li>• 您可以随时在“设置”中选择退出</li>
                  </ul>
                </div>
              </div>
            </Card>
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4">
            <div className="flex gap-2 items-start">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                这些数据能帮助我们了解哪些功能最有价值，识别性能问题，并确定改进的优先级。您的选择不会影响任何功能的正常使用。
              </p>
            </div>
          </div>
        </div>
          ...
          <Card className="p-4 shadow-lg border-purple-200 dark:border-purple-800">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2 flex-1">
                <p className="text-sm font-medium">帮助改进 opcode</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  我们收集匿名使用数据以改善您的体验。不收集任何个人数据。
                </p>
