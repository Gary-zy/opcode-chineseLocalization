          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="space-y-4 p-4 border rounded-lg bg-muted/20">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="color-background" className="text-caption">背景颜色</Label>
                          ...
                          {/* Foreground Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-foreground" className="text-caption">前景色</Label>
                            <div className="flex gap-2">
                              <Input
                                id="color-foreground"
                                type="text"
                          ...
                          {/* Primary Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-primary" className="text-caption">主色调</Label>
                            <div className="flex gap-2">
                              <Input
                                id="color-primary"
                                type="text"
                          ...
                          {/* Card Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-card" className="text-caption">卡片颜色</Label>
                            <div className="flex gap-2">
                              <Input
                                id="color-card"
                                type="text"
                          ...
                          {/* Destructive Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-destructive" className="text-caption">破坏性操作颜色</Label>
                            <div className="flex gap-2">
                              <Input
                        ...
                        <p className="text-caption text-muted-foreground">
                          使用 CSS 颜色值（hex, rgb, oklch 等）。更改将立即应用。
                        </p>
                      </div>
                    )}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5 flex-1">
                        ...
                        <p className="text-caption text-muted-foreground">
                          在 git commit 和 pull request 中添加 Claude 署名
                        </p>
                      </div>
                      <Switch
                        id="coauthored"
                    ...
                    {analyticsEnabled && (
                      <div className="rounded-lg border border-border bg-muted/50 p-3">
                        <div className="flex gap-2">
                          ...
                          <div className="space-y-1">
                            <p className="text-xs font-medium text-foreground">您的隐私受到保护</p>
                            <ul className="text-xs text-muted-foreground space-y-0.5">
                              <li>• 不收集个人信息或文件内容</li>
                              <li>• 所有数据均为匿名，使用随机 ID</li>
                              <li>• 您可以随时禁用分析</li>
                            </ul>
                          </div>
                        </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-body-small text-muted-foreground mb-4">
                      控制 Claude Code 在无需手动批准的情况下可以使用哪些工具
                    </p>
                  </div>
                  ...
                  <div className="pt-2 space-y-2">
                    ...
                    <ul className="text-caption text-muted-foreground space-y-1 ml-4">
                      ...
                      <li>• <code className="px-1 py-0.5 rounded bg-green-500/10 text-green-600 dark:text-green-400">Edit(docs/**)</code> - 允许编辑 docs 目录下的文件</li>
                    </ul>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6">
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      显示将保存到 ~/.claude/settings.json 的原始 JSON 内容
                    </p>
                  </div>
                </div>
              </Card>
            ...
            <TabsContent value="hooks" className="space-y-6">
              <Card className="p-6">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-base font-semibold mb-2">用户 Hooks</h3>
                    <p className="text-body-small text-muted-foreground mb-4">
                      配置应用于您用户帐户下所有 Claude Code 会话的 Hooks。
