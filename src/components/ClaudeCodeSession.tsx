                ...
                <div className="bg-background/95 backdrop-blur-md border rounded-lg shadow-lg p-3 space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="text-xs font-medium text-muted-foreground mb-1">
                      排队中的提示词 ({queuedPrompts.length})
                    </div>
                    <TooltipSimple content={queuedPromptsCollapsed ? "展开队列" : "折叠队列"} side="top">
                      <motion.div
                        whileTap={{ scale: 0.97 }}
                        transition={{ duration: 0.15 }}
                      >
          ...
          {displayableMessages.length > 5 && (
            ...
            >
              <div className="flex items-center bg-background/95 backdrop-blur-md border rounded-full shadow-lg overflow-hidden">
                <TooltipSimple content="回到顶部" side="top">
                  <motion.div
                    whileTap={{ scale: 0.97 }}
                    transition={{ duration: 0.15 }}
                  >
                ...
                <TooltipSimple content="到底部" side="top">
                  <motion.div
                    whileTap={{ scale: 0.97 }}
                    transition={{ duration: 0.15 }}
                  >
          ...
          <div className={cn(
            ...
            <FloatingPromptInput
              ...
              extraMenuItems={
                <>
                  {effectiveSession && (
                    <TooltipSimple content="会话时间线" side="top">
                      <motion.div
                        whileTap={{ scale: 0.97 }}
                        transition={{ duration: 0.15 }}
                      >
                  ...
                  {messages.length > 0 && (
                    <Popover
                      trigger={
                        <TooltipSimple content="复制会话" side="top">
                          <motion.div
                            whileTap={{ scale: 0.97 }}
                            transition={{ duration: 0.15 }}
                          >
                  ...
                  <TooltipSimple content="检查点设置" side="top">
                    <motion.div
                      whileTap={{ scale: 0.97 }}
                      transition={{ duration: 0.15 }}
                    >
                ...
                <div className="flex justify-end px-4 pb-2">
                  ...
                  >
                    <div className="flex items-center gap-1.5 text-xs">
                      ...
                      <span className="text-muted-foreground">词元 (tokens)</span>
                    </div>
                  </motion.div>
                </div>
              </div>
